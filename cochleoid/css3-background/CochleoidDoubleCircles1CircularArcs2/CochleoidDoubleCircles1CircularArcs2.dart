#library('CochleoidDoubleCircles1CircularArcs2');
#import('dart:dom');

main() {
  new CochleoidDoubleCircles1CircularArcs2();
}

class CochleoidDoubleCircles1CircularArcs2 {
   ...
   CochleoidDoubleCircles1CircularArcs2() {
