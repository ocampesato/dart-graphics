#library('CochleoidTripleCirclesRef1CircularArcs1');
#import('dart:dom');

main() {
  new CochleoidTripleCirclesRef1CircularArcs1();
}

class CochleoidTripleCirclesRef1CircularArcs1 {
   ...
   CochleoidTripleCirclesRef1CircularArcs1() {
