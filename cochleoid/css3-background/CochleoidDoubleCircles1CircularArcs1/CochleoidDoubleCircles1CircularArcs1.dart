#library('CochleoidDoubleCircles1CircularArcs1');
#import('dart:dom');

main() {
  new CochleoidDoubleCircles1CircularArcs1();
}

class CochleoidDoubleCircles1CircularArcs1 {
   ...
   CochleoidDoubleCircles1CircularArcs1() {
