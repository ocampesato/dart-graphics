#library('LituusDoubleCircles1CircularArcs2');
#import('dart:dom');

main() {
  new LituusDoubleCircles1CircularArcs2();
}

class LituusDoubleCircles1CircularArcs2 {
   ...
   LituusDoubleCircles1CircularArcs2() {
