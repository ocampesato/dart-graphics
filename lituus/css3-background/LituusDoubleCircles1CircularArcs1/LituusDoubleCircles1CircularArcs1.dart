#library('LituusDoubleCircles1CircularArcs1');
#import('dart:dom');

main() {
  new LituusDoubleCircles1CircularArcs1();
}

class LituusDoubleCircles1CircularArcs1 {
   ...
   LituusDoubleCircles1CircularArcs1() {
