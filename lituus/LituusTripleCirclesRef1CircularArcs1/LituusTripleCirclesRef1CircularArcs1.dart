#library('LituusTripleCirclesRef1CircularArcs1');
#import('dart:dom');

main() {
  new LituusTripleCirclesRef1CircularArcs1();
}

class LituusTripleCirclesRef1CircularArcs1 {
   ...
   LituusTripleCirclesRef1CircularArcs1() {
