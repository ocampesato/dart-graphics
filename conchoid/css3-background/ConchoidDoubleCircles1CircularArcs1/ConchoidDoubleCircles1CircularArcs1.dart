#library('ConchoidDoubleCircles1CircularArcs1');
#import('dart:dom');

main() {
  new ConchoidDoubleCircles1CircularArcs1();
}

class ConchoidDoubleCircles1CircularArcs1 {
   ...
   ConchoidDoubleCircles1CircularArcs1() {
