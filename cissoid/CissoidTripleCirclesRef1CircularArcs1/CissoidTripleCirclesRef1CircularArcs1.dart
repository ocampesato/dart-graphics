#library('CissoidTripleCirclesRef1CircularArcs1');
#import('dart:dom');

main() {
  new CissoidTripleCirclesRef1CircularArcs1();
}

class CissoidTripleCirclesRef1CircularArcs1 {
   ...
   CissoidTripleCirclesRef1CircularArcs1() {
