#library('CissoidDoubleCircles1CircularArcs2');
#import('dart:dom');

main() {
  new CissoidDoubleCircles1CircularArcs2();
}

class CissoidDoubleCircles1CircularArcs2 {
   ...
   CissoidDoubleCircles1CircularArcs2() {
