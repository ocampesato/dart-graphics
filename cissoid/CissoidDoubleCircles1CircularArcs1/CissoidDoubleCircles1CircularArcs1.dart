#library('CissoidDoubleCircles1CircularArcs1');
#import('dart:dom');

main() {
  new CissoidDoubleCircles1CircularArcs1();
}

class CissoidDoubleCircles1CircularArcs1 {
   ...
   CissoidDoubleCircles1CircularArcs1() {
