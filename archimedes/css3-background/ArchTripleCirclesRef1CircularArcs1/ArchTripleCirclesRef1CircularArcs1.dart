#library('ArchTripleCirclesRef1CircularArcs1');
#import('dart:dom');

main() {
  new ArchTripleCirclesRef1CircularArcs1();
}

class ArchTripleCirclesRef1CircularArcs1 {
   ...
   ArchTripleCirclesRef1CircularArcs1() {
