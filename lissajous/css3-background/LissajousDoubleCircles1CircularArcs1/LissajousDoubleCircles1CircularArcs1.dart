#library('LissajousDoubleCircles1CircularArcs1');
#import('dart:dom');

main() {
  new LissajousDoubleCircles1CircularArcs1();
}

class LissajousDoubleCircles1CircularArcs1 {
   ...
   LissajousDoubleCircles1CircularArcs1() {
