#library('LissajousTripleCirclesRef1CircularArcs1');
#import('dart:dom');

main() {
  new LissajousTripleCirclesRef1CircularArcs1();
}

class LissajousTripleCirclesRef1CircularArcs1 {
   ...
   LissajousTripleCirclesRef1CircularArcs1() {
