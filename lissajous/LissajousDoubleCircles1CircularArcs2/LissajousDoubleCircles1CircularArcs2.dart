#library('LissajousDoubleCircles1CircularArcs2');
#import('dart:dom');

main() {
  new LissajousDoubleCircles1CircularArcs2();
}

class LissajousDoubleCircles1CircularArcs2 {
   ...
   LissajousDoubleCircles1CircularArcs2() {
